                    ...
                    <div className="flex gap-3 items-center">
                        {PLANES.map(plan => (
                            <Fragment key={plan.id}>
                                ...
                                <input id={plan.id} type="radio" name="plan" value={plan.id} onChange={e => handleChangeDatos(e)}/>
                            </Fragment>
                        ))}
                    </div>
                </div>
                        
                <input type="submit" className='w-full bg-indigo-500 hover:bg-indigo-600 transition-colors text-white cursor-pointer p-3 uppercase font-bold' value="cotizar"></input>
